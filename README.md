...
This repository contains a microkinetic model for the Water–Gas Shift (WGS) reaction on cerium oxide, originally developed during my PhD and used in a published study.  
...
- Elementary reaction network for WGS on cerium oxide
...
- `get_drc(...)` → degree of rate control (DRC) calculation
